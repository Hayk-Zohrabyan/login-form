...
export const renderStyle = (props: ViewProps): { view: object } => {
  ...
  props.top && (viewStyle.top = moderateScale(props.top));
  props.bottom && (viewStyle.bottom = moderateScale(props.bottom));
  props.left && (viewStyle.left = moderateScale(props.left));
  props.right && (viewStyle.right = moderateScale(props.right));
